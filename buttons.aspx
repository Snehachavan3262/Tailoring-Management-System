...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="Coller.aspx">Collers</a>
      </li>
    </ul>
                ...
                <div class="container" style="margin-top: 20px; padding: 0px;">
                    <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 100%; padding: 0px; margin-bottom: 0px;">
                        ...
                        <h3 class="mb-3 HistoryHead" style="padding: 10px; margin: 0px;">
                           ...
                           Choose the Button you would like to Style
                        </h3>
...
<div class="Trending" >
    <div class="trend1">
        <div style="margin-right:25px;">
            ...
            <img src="https://sewguide.com/wp-content/uploads/2019/05/button-types2.jpg" style="height:400px; width:300px;"/>
             <p style="text-align:center; color:white;font-size:20px">Wooden Buttons</p>
       <br />
        </div>
          ...
          <div style="margin-right:25px;">
            ...
            <img src="https://sewguide.com/wp-content/uploads/2019/05/button-types1.jpg" style="height:400px; width:300px;"/>
             <p style="text-align:center; color:white;font-size:20px">Press Buttons / Snap Buttons</p>
        <br />
        </div>

        <div style="margin-right:25px;">
           
            <img src="https://sewguide.com/wp-content/uploads/2019/05/buttons21.jpg" style="height:400px; width:300px;"/>
            <p style="text-align:center; color:white;font-size:20px">Shank buttons</p>
        <br />
        </div>
          <div style="margin-right:25px;">
            
           
            <img src="https://sewguide.com/wp-content/uploads/2019/05/buttons3.jpg" style="height:400px; width:300px;"/>
             <p style="text-align:center; color:white; font-size:20px">Cloth Covered Buttons made with kits</p>
           
        </div>

           <div style="margin-right:25px;">
           
            <img src="https://sewguide.com/wp-content/uploads/2019/05/button-types26.jpg" style="height:400px; width:300px;"/>
             <p style="text-align:center; color:white;font-size:20px">Decorative buttons</p>
          
        </div>
            <div style="margin-right:25px;">
          
            <img src="https://sewguide.com/wp-content/uploads/2019/05/button-types27.jpg" style="height:400px; width:300px;"/>
             <p style="text-align:center; color:white;font-size:20px">Toggle button</p>
         <br />
        </div>
