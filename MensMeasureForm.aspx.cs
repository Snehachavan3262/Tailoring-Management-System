...
public partial class MensMeasureForm : System.Web.UI.Page
{
    string username;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            GetData();
            if (Request.QueryString["username"] != null) //access username from the querystring 
            {
                ...
                MySqlDataAdapter da = new MySqlDataAdapter("select Gender,username,mobile from Registration where username='" + username + "'", con);
                ...
                MySqlDataAdapter da1 = new MySqlDataAdapter("select OrderStatus from MensRegistration where FullName='" + username + "' and MobileNo='" + mobile + "'", con);
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        string Email = Request.Form["Email"];    //Take name from the Register.aspx form 
        string FullName = Request.Form["FullName"];
        string Amount = Request.Form["price"];
        string Type = Request.Form["Type"];
        string age = Request.Form["age"];    //Take name from the Register.aspx form 
        string weight = Request.Form["Weight"];
        string height = Request.Form["Height"];
        string fullshoulder = Request.Form["FullShoulder"];
        string backshoulder = Request.Form["BackShoulder"];
        string frontshoulder = Request.Form["FrontShoulder"];
        string chest = Request.Form["Chest"];    //Take name from the Register.aspx form 
        string sleeves = Request.Form["Sleeve"];
        string nack = Request.Form["Neck"];
        string JacketLength = Request.Form["JacketLength"];
        string crotch = Request.Form["Crotch"];
        string waist = Request.Form["Waist"];
        string hip = Request.Form["Hip"];    //Take name from the Register.aspx form 
        ...
        string seat = Request.Form["Seat"];
            ...
            string fab = Request.Form["shirtfabric"];
        ...
        Application["price"] = Amount;
            ...
            Application["FullShoulder"] = fullshoulder;
            Application["BackShoulder"] = backshoulder;
            Application["FrontShoulder"] = frontshoulder;
            Application["Chest"] = chest;
            Application["Sleeve"] = sleeves;
            Application["Neck"] = nack;
            Application["JacketLength"] = JacketLength;
            Application["Crotch"] = crotch;
    ...
    public void GetData()
    {
        ...
        using (MySqlConnection con = new MySqlConnection(connectionString))
        {
            ...
            // BusName.Items.Clear();
            string fabric = shirtfabric.SelectedValue;
            ...
            shirtfabric.DataTextField = "Name";
            shirtfabric.DataSource = dt;
            shirtfabric.DataBind();
    ...
    protected void shirtfabric_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        using (MySqlConnection con = new MySqlConnection(connectionString))
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select Price from T_Category  where Name='" + fabric + "'", con);
            MySqlDataAdapter adp = new MySqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            adp.Fill(dt);
