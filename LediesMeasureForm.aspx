<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LediesMeasureForm.aspx.cs" Inherits="LediesMeasureForm" %>
    ...
    <div class="page-body-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        <li><a class="sidebar-header" href="Dashboard.aspx"><i data-feather="box"></i><span>User Dashboard</span><i class="fa fa-angle-right pull-right"></i></a>
                            <ul class="sidebar-submenu">
                                <%--<li><a href="CheckStatus.aspx"><i class="fa fa-circle"></i>Check Order Status</a></li>--%>
        ...
        <div class="page-body">
            ...
            <!-- Container-fluid Ends-->
             <div class="form-row">
                        <div class="col-sm-4  col-sm-4 col-sm-4" style="background-color:#f6b9b9;margin-left:100px;height:90px;border-bottom-left-radius:30px; border-top-right-radius:30px; ">
                        ...
                        <form name="form1" runat="server" class="theme-form">
                              ...
                              <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control" id="age" name="age" placeholder="Age"
                                     ...
                                     <div class="col-md-3">
                                   <asp:DropDownList Id="fabric" CssClass="form-control" Height="50px" runat="server" style="margin-left:0px; margin-bottom:10px" OnSelectedIndexChanged="fabric_SelectedIndexChanged" AutoPostBack="true" >
                                        <asp:ListItem>Fabric For Dress</asp:ListItem>
                                   ...
                                   <asp:DropDownList ID="shirt" CssClass="form-control" Height="50px" runat="server" style="margin-left:0px; margin-bottom:10px">
                                        <asp:ListItem>Dress Style</asp:ListItem>
                                       <asp:ListItem>Panjabi</asp:ListItem>
                                       <asp:ListItem>Shorts Kurties</asp:ListItem>
                                        <asp:ListItem>Gown</asp:ListItem>
                                       <asp:ListItem>Party Wear</asp:ListItem>
                                ...
                                <div class="form-row">
                                   ...
                                   <asp:DropDownList ID="pantfabric" CssClass="form-control" Height="50px" runat="server" style="margin-left:0px; margin-bottom:10px">
                                       ...
                                       <asp:ListItem>Wool</asp:ListItem>
                                        <asp:ListItem>Streched Wool</asp:ListItem>
                                   ...
                                   <asp:DropDownList ID="pant" CssClass="form-control" Height="50px" runat="server" style="margin-left:0px; margin-bottom:10px">
                                      ...
                                      <asp:ListItem>Rinkle</asp:ListItem>
                                       <asp:ListItem>Dhoti</asp:ListItem>
                                       <asp:ListItem>Patiyala</asp:ListItem>
                                        <asp:ListItem>Straight Cut</asp:ListItem>
                                       <asp:ListItem>Jogger</asp:ListItem>
                                        <asp:ListItem>Leggins</asp:ListItem>
                                       <asp:ListItem>Palazzo</asp:ListItem>
                                        <asp:ListItem>Ciggarate</asp:ListItem>
                                   ...
                                   <div class="col-md-3">
                                    <asp:TextBox ID="price" runat="server" placeholder="Amount" CssClass="form-control"  Height="50px"  style="margin-left:0px; margin-bottom:10px"></asp:TextBox>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control" id="FrontL" name="FrontL" placeholder="Front Length"
                                        required="" style="margin-left:0px">
                                </div>

                                <div class="col-md-3">
                                    
                                    <input type="number" class="form-control" id="BackL" name="BackL" placeholder="Back Length"
                                        required=""  style="margin-left:0px">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control" id="FrontW" name="FrontW" placeholder="Front Width"
                                        required="" style="margin-left:0px">
                                </div>

                                <div class="col-md-3">
                                    
                                    <input type="number" class="form-control" id="BackW" name="BackW" placeholder="Back Width"
                                        required=""  style="margin-left:0px">
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control" id="Nack" name="Nack" placeholder="Nack"
                                        required=""  style="margin-left:0px">
                                </div>
                            </div>
                             ...
                             <div class="form-row">
                                <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control" id="Arm" name="Arm" placeholder="Arm"
                                        required="" style="margin-left:0px">
                                </div>

                                <div class="col-md-3">
                                    
                                    <input type="number" class="form-control" id="ArmH" name="ArmH" placeholder="Arm Hole"
                                        required=""  style="margin-left:0px">
                                </div>
                                   <div class="col-md-3">
                             ...
                             <div class="form-row">
                                ...
                                <div class="col-md-6">
                                     ...
                                     <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" CssClass="btn btn-solid" Text="Make Payment" />
                                </div>
