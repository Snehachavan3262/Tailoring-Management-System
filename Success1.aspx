<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Success1.aspx.cs" Inherits="Success1" %>
               ...
               <span class="loader"></span>
                ...
                <div class="content">
                  ...
                  <%--  <div class="col-md-12">
                                     ...
                                     <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" class="button" Text="Click To Save Record" style="margin-left:" />
                                </div>--%>
                </div>
            </div>
        </div>
