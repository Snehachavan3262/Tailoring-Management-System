...
public partial class SuccessInsert : System.Web.UI.Page
{
    ...
    {
        string fab = Application["fabric"].ToString();
        ...
        //get values from lediesmeasureform 
        ...
        string frontlenghth = Application["FrontL"].ToString();
        string backlength = Application["BackL"].ToString();
        string frontwidth = Application["FrontW"].ToString();
        string backwidth = Application["BackW"].ToString();
        string sleeves = Application["Sleeve"].ToString();
        string nack = Application["Nack"].ToString();
        string arm = Application["Arm"].ToString();
        string armhole = Application["ArmH"].ToString();
        ...
        con.Open();
        MySqlCommand cmd = new MySqlCommand("INSERT INTO LediesRegistration (MobileNo,Email,FullName,Amount,Type,Age,Weight,Height,FrontLength,BackLength,FrontWidth,BackWidth,Sleeves,Nack,Arm,ArmHole,Waist,Hip,TrouserLength,TrouserTight,TrouserCuff,Seat,OrderStatus,gender,Time,DressFabric,DressStyle,CollerStyle,PantFabric,PantStyle,Buttons,Suggesion) VALUES('" + MobileNo + "','" + Email + "','" + FullName + "','" + Amount + "','" + Type + "','" + age + "','" + weight + "','" + height + "','" + frontlenghth + "','" + backlength + "','" + frontwidth + "','" + backwidth + "','" + sleeves + "','" + nack + "','" + arm + "','" + armhole + "','" + waist + "','" + hip + "','" + trouserlength + "','" + trousertight + "','" + trousercuff + "','" + seat + "','"+ order + "','"+ gender + "','"+ date + "','" + fab + "','" + dress + "','" + coll + "','" + pantfab + "','" + pantstyle + "','" + btn + "','" + sugg + "')", con);
    ...
    //WebResponse.Write("<script>alert('Record save sucessfully')</script>");
    ...
    //    MySqlConnection con = new MySqlConnection(cs);
    //    con.Open();
    //    MySqlCommand cmd = new MySqlCommand("INSERT INTO LediesRegistration (MobileNo,Email,FullName,Amount,Type,Age,Weight,Height,FrontLength,BackLength,FrontWidth,BackWidth,Sleeves,Nack,Arm,ArmHole,Waist,Hip,TrouserLength,TrouserTight,TrouserCuff,Seat) VALUES('" + MobileNo + "','" + Email + "','" + FullName + "','" + Amount + "','" + Type + "','" + age + "','" + weight + "','" + height + "','" + frontlenghth + "','" + backlength + "','" + frontwidth + "','" + backwidth + "','" + sleeves + "','" + nack + "','" + arm + "','"+armhole+ "','" + waist + "','" + hip + "','" + trouserlength + "','" + trousertight + "','" + trousercuff + "','" + seat + "')", con);
