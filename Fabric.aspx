<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fabric.aspx.cs" Inherits="Fabric" %>
<!DOCTYPE html>
                ...
                <div class="container" style="margin-top: 20px; padding: 0px;">
                    <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 100%; padding: 0px; margin-bottom: 0px;">
                        ...
                        <h3 class="mb-3 HistoryHead" style="padding: 10px; margin: 0px;">
                           ...
                           Choose the Fabric you would like to stitch
                        </h3>
...
<div class="Trending" >
    <div class="trend1">
        <div style="margin-right:25px;">
            ...
            <img src="https://i0.wp.com/withmyhandsdream.com/wp-content/uploads/2018/11/IMG_0788.png?resize=300%2C300&ssl=1"/></a>
           <br />

            <p style="text-align:center; color:white;font-size:20px">Wool</p>
        </div>

        <div style="margin-right:25px;">
          
            <img src="https://i0.wp.com/withmyhandsdream.com/wp-content/uploads/2018/11/IMG_6678-1.png?resize=300%2C300&ssl=1"/>
             <p style="text-align:center; color:white;font-size:20px">Cotton</p>
         <br />
        </div>

        <div style="margin-right:25px;">
           
            <img src="https://i0.wp.com/withmyhandsdream.com/wp-content/uploads/2018/11/IMG_4373.png?resize=300%2C311&ssl=1"/>
            <p style="text-align:center; color:white;font-size:20px">Linen</p>
        <br />
        </div>
        ...
        <div style="margin-right:25px;">
            ...
            <img src="https://i0.wp.com/withmyhandsdream.com/wp-content/uploads/2018/11/IMG_4712.png?resize=300%2C300&ssl=1"/>
             <p style="text-align:center; color:white;font-size:20px">Silk</p>
       <br />
        </div>
         <div style="margin-right:25px;">
           
            <img src="https://i0.wp.com/withmyhandsdream.com/wp-content/uploads/2018/11/IMG_4374.png?resize=300%2C300&ssl=1"/>
            <p style="text-align:center; color:white;font-size:20px">Lawn</p>
       <br />
        </div>
     ...
     <div class="trend1">
        <div style="margin-right:25px;">
            ...
            <img src="https://i0.wp.com/withmyhandsdream.com/wp-content/uploads/2018/11/IMG_6235.png?resize=300%2C300&ssl=1"/></a>
             <p style="text-align:center; color:white; font-size:20px">Polyester</p>
           
        </div>

        <div style="margin-right:25px;">
          
            <img src="https://i0.wp.com/withmyhandsdream.com/wp-content/uploads/2018/11/IMG_4362-1.png?resize=300%2C300&ssl=1"/>
             <p style="text-align:center; color:white;font-size:20px">Viscose</p>
         <br />
        </div>

        <div style="margin-right:25px;">
           
            <img src="https://i0.wp.com/withmyhandsdream.com/wp-content/uploads/2018/09/autumn_fabrics_and_sewing_plans-17-e1541528683440.jpg?resize=300%2C300&ssl=1"/>
             <p style="text-align:center; color:white;font-size:20px">Crepe</p>
        <br />
        </div>
        ...
        <div style="margin-right:25px;">
            ...
            <img src="https://i0.wp.com/withmyhandsdream.com/wp-content/uploads/2018/11/IMG_0602.png?resize=300%2C300&ssl=1"/>
             <p style="text-align:center; color:white;font-size:20px">Jersey</p>
        ...
        <div style="margin-right:25px;">
            ...
            <img src="https://i0.wp.com/withmyhandsdream.com/wp-content/uploads/2018/11/chiffon.jpg?w=300&ssl=1"/>
            <p style="text-align:center; color:white;font-size:20px">Chiffon</p>
